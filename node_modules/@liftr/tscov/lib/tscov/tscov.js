...
var Tscov = /** @class */ (function () {
    ...
    Tscov.prototype.executeTscov = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var argv, showVersion, showHelp, projectInput, fileInput, _a, correctCount, totalCount, anys, openCount, percentage, minCoverage, failed, success, anys_1, anys_1_1, _b, file, line, character, text;
            var e_1, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        projectInput = argv.p || argv.project;
                        fileInput = argv.f || argv.file;
                        ...
                        return [4 /*yield*/, this.checkTypes.startLinter(projectInput, true, argv.debug, fileInput)];
                    case 1:
                        _a = _d.sent(), correctCount = _a.correctCount, totalCount = _a.totalCount, anys = _a.anys;
                        ...
                        if (argv.d || argv.details || failed) {
                            ...
                            try {
                                for (anys_1 = tslib_1.__values(anys), anys_1_1 = anys_1.next(); !anys_1_1.done; anys_1_1 = anys_1.next()) {
                                    _b = anys_1_1.value, file = _b.file, line = _b.line, character = _b.character, text = _b.text;
                                ...
                                try {
                                    if (anys_1_1 && !anys_1_1.done && (_c = anys_1.return)) _c.call(anys_1);
                                }
